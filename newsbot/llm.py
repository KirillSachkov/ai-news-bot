...
- Сравнивай даты в тексте с сегодняшней. Если событие случилось больше двух суток назад, а публикация не приносит нового факта (пересказ, обзор, реакция) — это старьё: score не выше 4. «Найдено в источнике» — время, когда источник это показал, а не дата события.
- GitHub-репозиторий, созданный больше двух суток назад, который сопровождает уже объявленный результат (код или доказательства к статье, анонсу, релизу лаборатории), — это не новость, а приложение к старому сюжету: score не выше 4. Самостоятельный полезный инструмент оценивай как инструмент, его возраст не важен.
